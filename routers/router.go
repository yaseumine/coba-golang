...
"github.com/yourusername/gin-firebase-backend/handlers"
"github.com/yourusername/gin-firebase-backend/middleware"
)
...
{
products.GET("", productHandler.GetAll) // GET
/v1/products
products.GET("/:id", productHandler.GetByID) // GET
/v1/products/:id
// Create, Update, Delete — hanya admin
adminProducts := products.Group("")
adminProducts.Use(middleware.AdminOnly())
{
adminProducts.POST("", productHandler.Create) // POST
/v1/products
adminProducts.PUT("/:id", productHandler.Update) // PUT
/v1/products/:id
